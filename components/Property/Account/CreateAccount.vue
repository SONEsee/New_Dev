...
const filteredParentAccounts = computed(() => {
  if (!accountStoreInstance.form_create_account.account_type) {
    return parentAccounts.value;
  }
  return parentAccounts.value.filter(
    account => account.account_type === accountStoreInstance.form_create_account.account_type
  );
});
...
const submitForm = async () => {
  ...
  if (isValid) {
    const notification = await CallSwal({
      icon: "warning",
      title: "ຄຳເຕືອນ",
      text: `ທ່ານກຳລັງເພີ່ມບັນຊີໃໝ່ ທ່ານແນ່ໃຈແລ້ວບໍ່?`,
    ...
    if (notification.isConfirmed) {
      await accountStoreInstance.CreateAccount();
    }
  }
};
...
watch(
  () => accountStoreInstance.form_create_account.account_type,
  () => {
    accountStoreInstance.form_create_account.parent_account_id = null;
  }
);
        ...
        <v-col cols="12" class="pt-12">
          <v-row>
            <v-col cols="12" md="6">
              ...
              <v-text-field
                v-model="accountStoreInstance.form_create_account.account_code"
              ...
              <v-text-field
                v-model="accountStoreInstance.form_create_account.account_name"
              ...
              <v-select
                v-model="accountStoreInstance.form_create_account.account_type"
            ...
            <v-col cols="12" md="6">
              ...
              <v-autocomplete
                v-model="accountStoreInstance.form_create_account.parent_account_id"
              ...
              <v-textarea
                v-model="accountStoreInstance.form_create_account.description"
              ...
              <!-- <v-card variant="outlined" class="mt-4">
                ...
                <v-card-text class="pt-0">
                  <v-list density="compact">
                    <v-list-item>
                      <v-list-item-title class="text-subtitle-2">ຊັບສິນ:</v-list-item-title>
                      <v-list-item-subtitle>1000000 - 1999999</v-list-item-subtitle>
                    </v-list-item>
                    <v-list-item>
                      <v-list-item-title class="text-subtitle-2">ໜີ້ສິນ:</v-list-item-title>
                      <v-list-item-subtitle>2000000 - 2999999</v-list-item-subtitle>
                    </v-list-item>
                    <v-list-item>
                      <v-list-item-title class="text-subtitle-2">ທຶນ:</v-list-item-title>
                      <v-list-item-subtitle>3000000 - 3999999</v-list-item-subtitle>
                    </v-list-item>
                    <v-list-item>
                      <v-list-item-title class="text-subtitle-2">ລາຍຮັບ:</v-list-item-title>
                      <v-list-item-subtitle>4000000 - 4999999</v-list-item-subtitle>
                    </v-list-item>
                    <v-list-item>
                      <v-list-item-title class="text-subtitle-2">ຄ່າໃຊ້ຈ່າຍ:</v-list-item-title>
                      <v-list-item-subtitle>5000000 - 5999999</v-list-item-subtitle>
                    </v-list-item>
                  </v-list>
                </v-card-text>
              </v-card> -->
